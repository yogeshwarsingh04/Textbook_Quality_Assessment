...
<body>
    ...
    <main class="container admin-table">
                            ...
                            <td>
                                <form action="manageApplication" method="POST" style="display:inline;">
                                    ...
                                    <button type="submit" class="approve">
                                    	<i data-feather="check" style="width:14px; height:14px; vertical-align: middle; margin-right: 3px;"></i> Approve
                                    </button>
                                </form>
                                <form action="manageApplication" method="POST" style="display:inline;">
                                    <input type="hidden" name="userId" value="<%= app.getExpertId() %>">
                                    ...
                                    <button type="submit" class="reject">
                                    	<i data-feather="x" style="width:14px; height:14px; vertical-align: middle; margin-right: 3px;"></i> Reject
                                    </button>
                                </form>
                            </td>
                        </tr>
