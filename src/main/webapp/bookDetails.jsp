...
<head>
    ...
    <style>
        ...
        .expert-badge { background-color: var(--pico-primary, #007bff); }
        .educator-badge { background-color: #28a745; } /* Hard-coded green */

        article.review-card {
            /* * We are FORCING the background to be a lighter dark-mode color.
             * --pico-secondary-background is a light grey/blue (#19232c).
             */
            background-color: var(--pico-secondary-background, #19232c);
            
            /* And we'll add a more visible border */
            border: 1px solid var(--pico-muted-border-color, #2d3e4f);
        ...
        /* Use borders to highlight special reviews */
        article.expert-review {
            border-left: 4px solid var(--pico-primary, #007bff);
        }
        article.educator-review {
            border-left: 4px solid #28a745;
        }

        /* Adjust footer font size for reviews */
        article.review-card footer small {
            font-size: 0.8em;
            color: var(--pico-secondary-text-color);
        }
